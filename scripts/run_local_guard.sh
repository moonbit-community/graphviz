...
guard_env_fingerprint="frozen=${LOCAL_GUARD_FROZEN-}|submodule_check=${LOCAL_GUARD_SUBMODULE_CHECK-}|suppress_cc_warn=${LOCAL_GUARD_SUPPRESS_CLANG_EXIT_WARNING-}|sanitize_dot_env=${LOCAL_GUARD_SANITIZE_DOT_ENV-}|moon_jobs=${MOON_TEST_JOBS-}|strict_parity_jobs=${STRICT_PARITY_JOBS-}|capture_jobs=${CAPTURE_ENV_INVARIANCE_JOBS-}|write_parity_artifacts=${DOT_WRITE_PARITY_ARTIFACTS-}"
...
guard_cache_key="${tree_hash}|${moon_version}|${guard_env_fingerprint}"
