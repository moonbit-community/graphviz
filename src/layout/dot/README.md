...
- `bash scripts/generate_textspan_fixtures_from_xdot.sh` (updates `src/layout/dot/font_metrics/textspan_overrides.jsonl` from xdot snapshots; requires `python3`).
- `bash scripts/generate_textspan_overrides.sh` (updates `src/layout/dot/font_metrics/textspan_overrides.generated.mbt` from `src/layout/dot/font_metrics/textspan_overrides.jsonl`).
...
- Edge routing + splines / pathplan
  - MoonBit: `src/layout/dot/routing/integration/*`, `src/layout/dot/clustering/subgraph_layout.mbt`, `src/layout/dot/routing/*`, `src/layout/dot/routing/pathplan/*`, `src/layout/dot/routing/routesplines/*`, `src/layout/dot/routing/edge_spline/*`, `src/layout/dot/routing/edge_ops/*`
...
- Label placement + text metrics
  - MoonBit: `src/layout/dot/font_metrics/*`, `src/layout/dot/label_metrics/*`, `src/layout/dot/label_layout/*`, `src/layout/dot/finalization/*`
...
- Record shape layout / ports
  - MoonBit: `src/layout/dot/node_geometry/*`, `src/layout/dot/label_layout/record_layout/*`, `src/layout/dot/label_layout/html_layout/*`, `src/layout/dot/label_layout/port_geometry/*`
