...
- `bash scripts/generate_xdot_snapshots.sh` (refreshes `tests/render/xdot/*.xdot`; requires `dot`).
- `bash scripts/generate_svg_snapshots.sh` (refreshes `tests/render/svg/*.svg`; requires `dot`).
