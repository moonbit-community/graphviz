...
- `bash scripts/generate_textspan_fixtures_from_xdot.sh` (updates full override source `src/layout/dot/font_metrics/textspan_overrides.jsonl` and representative test sample `tests/fixtures/graphviz/textspan.jsonl` from xdot snapshots; requires `python3`).
